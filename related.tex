...
Writing test cases for smart contracts is considered fifficult
...
Moreover, test cases for smart contracts can
...
Fuzzing has also been used to generate or strengthen test cases for
smart contracts~\cite{LahamiKMMR24,WongZNLCYLLW24}.

Test cases can be tested themselves, in order to evaluate their
