...
\usepackage[mode=text,group-four-digits=true,group-separator={,}]{siunitx}
\sisetup{locale=US}
\newcommand{\numt}[1]{\num{#1}}
...
\colorlet{verylightblue}{blue!10!white}
...
\lstdefinelanguage{Java}{
  keywords=[1]{assert, break, case, catch, class, final, continue, default, do, else, extends, static, false, finally, for, if, implements, import, instanceof, interface, new, private, protected, public, return, super, switch, this, throw, throws, true, try, var, while }, % generic keywords including crypto operations
  keywordstyle=[1]\color{blue}\bfseries,
  keywords=[2]{BigInteger, int, float, double, short, byte, long, boolean, void, String},
  keywordstyle=[2]\color{teal}\bfseries,
  keywords=[3]{@Test, @BeforeAll, @BeforeEach, @Throws},
  keywordstyle=[3]\color{violet}\bfseries,
  identifierstyle=\color{black},
  sensitive=true,
  comment=[l]{//},
...
\author{Sara Migliorini\orcidlink{0000-0003-3675-7243} \and Fausto Spoto\orcidlink{0000-0003-2973-0384}}
...
\begin{abstract}
  \input{abstract}
  \keywords{Smart contract testing \and Blockchain \and Open-closed principle \and Design patterns \and Takamaka \and Hotmoka}
\end{abstract}
...
All links were last followed on July 7, 2026.
\end{document}
