...
This article has shown that a single abstract blockchain interface
...
implementation over the Tendermint engine (proof of stake) had been completed.
...
However, a single abstract blockchain interface can be used also
for other blockchains, such as Web3 for Ethereum.
...
not related to the use of a single abstract blockchain interface.
...
further increase the time for executing the testcases,
